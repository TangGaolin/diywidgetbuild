 ...
 */
define(['jquery','color_thief','util2','data_format'], function ($,color_thief,util,format_data) {
    ...
    var default_fontfamily_file = 'sans-serif';
    ...
    var initWidgetConfig = function(){
        ...
        if(fonts_msg.length > 0){
            ...
            this.fonts_config = fonts_msg;
            this.default_fontfamily_file = 'sans-serif';
